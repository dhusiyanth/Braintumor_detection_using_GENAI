...
% Last Modified by GUIDE v2.5 19-Nov-2024 14:05:44
...
imshow(brainImg);
axis off
helpdlg(' Image preprocessed & segmented  successfully ', 'Alert');
...
axes(handles.axes3);
imshow(imagNew,[]);
figure('Name','Generative adversarial network (GAN)','NumberTitle','off');
imshow(imagNew,[]);
